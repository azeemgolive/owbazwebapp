...
namespace Owbaz\JobseekerBundle;
...
class ImageHelper {
    ...
    public function __construct($category, $entity) {
        ...
        $this->user_image=$entity->getUserImage();
...
//--------------------------------------------------------------------
     ...
     public function upload() {
        ...
        $this->entity->setUserImage($this->user_image);        
...
//--------------------------------------------------------------------
    public function uploadProductTempImage()
    {
        ...
        $this->user_image=$new_name;
        $this->entity->setImage($this->user_image);        
        $this->resize_image();        
...
//---------------------------------------------------------------------
    ...
    public function getImagePaths() {
        ...
        foreach ($this->conf as $key => $value) {
            $value = $this->validateConf($value);
            $n[$key] = $this->generateImagePath($key, $value, $this->user_image);
        }
        return $n;
    }
    //-------------------------------------------------------
    ...
    {
        return $this->generateImagePath($key, $value, $this->user_image);
    }
    //--------------------------------------------------------------------
...
//-------------------------------------------------------
    private function getAbsolutePath() {
        return null === $this->user_image? null : $this->getUploadRootDir() . '/' . $this->user_image;
    }
